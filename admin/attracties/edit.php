    ...
    <div class="container">
        ...
        <form action="../backend/ridesController.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="int" name="min_length" id="min_length" class="min_length" value="<?php echo $ride['min_length']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="min_length">Beschrijving:</label>
                <input type="text" name="description" id="description" class="description" value="<?php echo $ride['description']; ?>">
            </div>
